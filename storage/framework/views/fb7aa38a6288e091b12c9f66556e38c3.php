...
<div class="max-w-4xl">
    <form action="<?php echo e(route('admin.blog.update', $blog)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e($blog->slug); ?>" disabled
                            class="w-full px-4 py-2 border border-gray-200 rounded-lg bg-gray-50 text-gray-500">
                        <p class="text-xs text-gray-500 mt-1">URL: <?php echo e(route('blog.show', $blog->slug)); ?></p>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="excerpt" rows="2"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                            placeholder="Brief summary for listings and search results (max 500 chars)"><?php echo e(old('excerpt', $blog->excerpt)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="content" rows="15" required
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                            placeholder="Write your blog post content here..."><?php echo e(old('content', $blog->content)); ?></textarea>
                    ...
                    <div>
                        ...
                        <?php if($blog->featured_image): ?>
                            <div class="mb-3 p-4 bg-gray-50 rounded-lg border border-gray-200">
                                <img src="<?php echo e($blog->featured_image); ?>" alt="" class="w-48 h-32 object-cover rounded mb-2">
            ...
            <div class="p-6 border-b border-gray-200">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="meta_title" value="<?php echo e(old('meta_title', $blog->meta_title)); ?>" maxlength="70"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" rows="2" maxlength="160"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                            placeholder="SEO description (max 160 characters)"><?php echo e(old('meta_description', $blog->meta_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="meta_keywords" value="<?php echo e(old('meta_keywords', $blog->meta_keywords)); ?>"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
            ...
            <div class="p-6 border-b border-gray-200">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="priority" value="<?php echo e(old('priority', $blog->priority)); ?>" min="0"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\My Files\Dev\ecom\resources\views\admin\blog\edit.blade.php ENDPATH**/ ?>